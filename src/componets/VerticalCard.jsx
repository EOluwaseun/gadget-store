...
function VerticalCard({ loading, data = [] }) {
  ...
  return (
    <div className="grid grid-cols-[repeat(auto-fit,minmax(260px,300px))] justify-center md:justify-between md:gap-6">
      {loading
        ? loadingList.map((item, i) => {
            return (
              <div
                key={i}
                className="w-full min-w-[280px] md:min-w-[300px] h-36 max-w-[200px] md:max-w-[310px] bg-white rounded-sm shadow flex"
              >
